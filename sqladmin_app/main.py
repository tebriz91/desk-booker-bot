...
from sqladmin_app.auth import get_auth_backend
from sqladmin_app.model_views import (
    UserAdmin,
...
templates = Jinja2Templates(directory="sqladmin_app/templates")
...
# Serve login page and handle login form submission
@app.get("/")
