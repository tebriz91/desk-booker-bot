...
@inline_router.message(Command('book'), StateFilter(default_state))
...
@inline_router.callback_query(StateFilter(FSMBooking.select_date))
...
@inline_router.callback_query(StateFilter(FSMBooking.select_room))
async def process_callback_query_3(
    ...
    keyboard = create_inline_kb_2(desks, 1, last_btn='Cancel')
...
@inline_router.callback_query(StateFilter(FSMBooking.select_desk))
