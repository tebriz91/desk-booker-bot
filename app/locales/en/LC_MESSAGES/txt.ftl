...
team-button-bookings = Team Bookings
team-bookings-no-bookings-message = Team: <b>{$team_name}</b> has no 🚩bookings
team-bookings-first-line = <b>🚩Bookings (Team: {$team_name}):</b>
team-bookings-date = <b>{$date}</b>
team-bookings-room-desk-user = Room: {$room_name}, Desk: {$desk_name}, {$telegram_name}
team-bookings-no-bookings-assignments = Team: <b>{$team_name}</b> has no 🚩bookings and active 🔒permanent desk assignments
team-bookings-desk-assignments-first-line = <b>Active 🔒permanent desk assignments (Team: {$team_name}):</b>
