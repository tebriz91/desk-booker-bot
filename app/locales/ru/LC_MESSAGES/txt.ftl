...
<#-- booking_dialog -->
booking-random-button = 🎲Случайный стол🎲
...
desk-booker-random-no-desks = На выбранную дату: {$date} нет доступных столов для бронирования
...
team-button-bookings = Брони команды
team-bookings-no-bookings-message = В команде: <b>{$team_name}</b> нет обычных 🚩броней столов
team-bookings-first-line = <b>🚩Брони столов в команде: {$team_name}</b>
team-bookings-date = <b>{$date}</b>
team-bookings-room-desk-user = Кабинет: {$room_name}, стол: {$desk_name}, {$telegram_name}
team-bookings-no-bookings-assignments = В команде: <b>{$team_name}</b> нет ни обычных 🚩броней, ни активных 🔒постоянных броней столов
team-bookings-desk-assignments-first-line = <b>Активные 🔒постоянные брони столов в команде: {$team_name}</b>
team-bookings-desk-assignments-weekday = {$weekday}